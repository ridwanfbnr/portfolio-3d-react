  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: import.meta.env.VITE_APP_EMAILJS_TO_NAME, // personal name
          from_email: form.email,
          to_email: import.meta.env.VITE_APP_EMAILJS_TO_EMAIL, // personal email
      ...
      <motion.div
        ...
        <form
          ...
          <button
            ...
            className={`${
              !isSubmitEnabled ? "cursor-not-allowed" : ""
